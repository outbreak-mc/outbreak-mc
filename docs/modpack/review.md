...
Сообщения теперь отправляются с плавной анимацией и содержат лицо скина отправителя слева, а ещё длина прокрутки истории чата была расширена.
...
В зельеварку установлена схема от [THE_PINPAL](https://www.curseforge.com/minecraft/texture-packs/in-game-brewing-guide), благодаря [xali's Potion](https://modrinth.com/resourcepack/xalis-potion) все зелья выглядят по-разному, а книги снабжены нашими собственными иконками!
...
Мы установили мод [Better F3](https://modrinth.com/mod/betterf3) и настроили его, убрав из панелей F3 всю ненужную информацию. Теперь вся информация разделена на группы разного цвета, в которых легко найти то, что нужно.
